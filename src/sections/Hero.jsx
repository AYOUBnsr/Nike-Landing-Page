    ...
    return (
        ...
        min-h-screen gap-10 max-container">
            ...
            justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                arrivais, quality comfort,
                and innvation for your
                active life.</p>
                <Button 
                    label="Show now"
                    iconURL={arrowRight} 
            ...
            <div className="relative flex flex-1 justify-center items-center xl:min-h-screan max-xl:py-40 bg-primary bg-hero gb-cover gb-center">
                <img 
                    src={bigShoeImg}
                    alt="shoe collection"
                    width={610}
